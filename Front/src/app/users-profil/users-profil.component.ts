...
export class UsersProfilComponent {
  ...
  deleteUser() {
    ...
    this.disabled_state = true;
    this.userService.deleteUser(this.selectedData).subscribe((data) => {
  ...
  updateUser() {
    if (this.selectedRole == undefined) {
      ...
      this.userService.updateUser(this.selectedData).subscribe((data) => {
